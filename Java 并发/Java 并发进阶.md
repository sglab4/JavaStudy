...
![](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559159.png)
...
![synchronized关键字原理](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559292.png)
...
![synchronized关键字原理](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559842.png)
...
**“可重入锁”** 指的是自己可以再次获取自己的内部锁。比如一个线程获得了某个对象的锁，此时这个对象锁还没有释放，当其再次想要获取这个对象的锁的时候还是可以获取的，**如果不可锁重入的话，就会造成死锁**。同一个线程每次获取锁，**锁的计数器**都自增 1，所以要等到锁的计数器下降为 0 时才能释放锁。
...
![CPU Cache](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559624.png)
...
![JMM(Java内存模型)](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559976.png)

要解决这个问题，就需要把变量声明为**`volatile`**，这就指示 JVM，这个变量是共享且不稳定的，每次使用它都到主存中进行读取。

所以，**`volatile` 关键字 除了防止 JVM 的指令重排 ，还有一个重要的作用就是保证变量的可见性。**

![volatile关键字的可见性](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559016.png)
...
![ThreadLocal数据结构](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559897.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559087.png)
...
**方式一：通过构造方法实现**
![ThreadPoolExecutor构造方法](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101435200.png)
...
![Executor框架的工具类](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101535008.png)
...
![图解线程池实现原理](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101534315.png)
...
![JUC原子类概览](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101534538.png)
...
![AQS类](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559178.png)
...
![AQS原理图](https://gitee.com/sgkurisu/pic-go/raw/master/picture2/202112101559852.png)
