...
![JUC原子类概览](https://pict-picgo.oss-cn-hangzhou.aliyuncs.com/picture3/202208061644004.png)
...
public class AtomicStampedReferenceDemo {
    public static void main(String[] args) {
        ...
        // 获取当前的值和当前的 stamp 值
        int[] arr = new int[1];
        // AtomicStampedReference 的 get 方法，参数为长度大于等于 1 的 int 数组，返回值为 reference，数组的第一个元素即索引为 0 的元素为 stamp
...
public class AtomicMarkableReferenceDemo {
    public static void main(String[] args) {
        ...
        // AtomicMarkableReference 的 get 方法和 AtomicStampedReference 的 get 方法相似，不过 AtomicMarkableReference 的标记即 mark 为 false 和 true，因此传入的参数为 boolean 类型的长度大于等于 1 的数组，返回值为 Reference，数组索引为 0 的位置为 m
